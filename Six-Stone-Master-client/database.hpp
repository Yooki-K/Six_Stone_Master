...
{  
    ...
    COMM_SERVER_GAMESTART,//双方准备，服务器开始游戏
    COMM_SERVER_GAMEOVER,//某方玩家胜利，服务器结束游戏

    COMM_CLIENT_CREATE,//客户端请求创建主机
    COMM_CLIENT_JOIN,//客户端请求加入房间
    COMM_CLIENT_REFLASH,//玩家刷新游戏大厅//
    COMM_CLIENT_GAMEOP,//玩家游戏操作：落子//
    COMM_CLIENT_UNDO,//玩家游戏操作：悔棋//
    COMM_CLIENT_UNDO_YES,//玩家游戏操作：悔棋回复yes//
    COMM_CLIENT_UNDO_NO, //玩家游戏操作：悔棋回复no//
    COMM_CLIENT_LOSE,//玩家游戏操作：认输//
    COMM_CLIENT_IP,//玩家发来ip地址
    COMM_CLIENT_CHAT,//玩家游戏操作：发送聊天信息//
    COMM_CLIENT_WIN,//玩家发送胜利，游戏结束
    COMM_CLIENT_QUITGAME,//玩家退出游戏//
    COMM_CLIENT_HEAD//玩家发送头像//
};
